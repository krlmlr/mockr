...
The mockr package helps testing code that relies on functions that are slow,
...
The pillar package contains [an example](https://github.com/r-lib/pillar/blob/fd6376eca74e9748ed616c49f906529eaee68df9/tests/testthat/helper-unknown-rows.R)
where a class with changed behavior for `dim()` and `head()` for the sole purpose of testing.
